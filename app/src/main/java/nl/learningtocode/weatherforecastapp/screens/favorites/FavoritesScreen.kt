...
import nl.learningtocode.weatherforecastapp.WeatherApp
...
fun CityRow(
    ...
    Surface(modifier = Modifier
        ...
        .height(50.dp)
        .clickable {
                   navController.navigate(WeatherScreens.MAIN_SCREEN.name + "/${favorite.city}")
        },
            shape = CircleShape.copy(topEnd = CornerSize(5.dp)),
            color = Color(0xFF866FE9)
    ) {
